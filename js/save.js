...
function back()
{
    let confirm = window.confirm("Проверьте, сохранились ли вы! \nПосле нажатия на кнопку «‎ДА» - вы попадёте на сайт.‎ \nВозможно, вы не увидите изменения содержимого, необходимо произвести «‎горячую перезагрузку», чтобы обновить кэш.");
    if (confirm) 
